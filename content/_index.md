      ...
      items:
        ...
        - title: Research Assistant
          ...
          description: |2-
              ...
              * I developed a novel Bayesian model to analyze mutational signatures in cancer by integrating Hierarchical Dirichlet Processes (HDP) with evolutionary trees. This approach leverages the phylogenetic relationships between cancer subclones, assuming that evolutionarily closer cells will exhibit more similar mutational signature activities. A prototype was implemented and applied to a single-cell sequencing dataset to estimate the mutational signatures and their corresponding activities across the cellular phylogeny. My blog post can be found [here](https://danielfridljand.de/post/mutational-signature-with-hierarchical-dirichlet-process/).
        - title: Research Assistant
