...
Our production architecture for first-level customer support splits the problem into small steps, uses LLMs for interpretation, and keeps everything else in code. It is the production version of the approach described in [Agentic vs Workflow-based AI](https://danielfridljand.de/post/workflow-vs-agent).
