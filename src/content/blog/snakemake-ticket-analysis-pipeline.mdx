...
tags:
  - Data Engineering
  - Python
description: "How I used Snakemake to manage a complex 19-stage ticket analysis pipeline, leveraging scatter-gather parallelization to efficiently process a couple of thousand customer support tickets with LLM classification."
...
```json
{
  ...
  "comments": [
    {
      "body": "Hello,\n\nI ordered two items online last week and they still haven't arrived.\nSent from my iPhone",
      "created_at": "2025-01-14T10:01:57Z",
      "author_role": "customer"
    },
    {
      "body": "Hello,\n\nI have re-sent your confirmation of purchase.\nI am also attaching the documents to this email, just in case.\n\nKind regards,\nSupport Team",
      "created_at": "2025-01-14T10:14:46Z",
      "author_role": "agent"
    }
  ],
  "customer_intent": "OrderNotReceived"
}
```
