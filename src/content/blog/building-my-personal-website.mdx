...
This post covers three parts of the implementation:
...
The three parts divide responsibilities clearly:

- **The chat interface** uses real-time streaming, AI integration, and context-aware systems
