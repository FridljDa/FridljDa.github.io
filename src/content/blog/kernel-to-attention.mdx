...
This is the **dot-product attention score**. It tells us the *form* of the similarity — but not its magnitude. The bandwidth $\sigma$ is still a free parameter; [§5](#5-scaling-why-divide-by-sqrtd) determines its standard value.
