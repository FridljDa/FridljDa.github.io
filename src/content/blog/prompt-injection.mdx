...
In this demonstration, our attacking voice agent first convinced the AI chat system's "customer support" to transfer it to "technical support," which had access to the password. It then exploited prompt injection vulnerabilities to trick the technical support agent into revealing the password. In practise, this meant threatening the technical support until it gave up.
