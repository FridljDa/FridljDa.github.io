...
Here you can see our voice agent extracting the password from a vulnerable AI chat system during the hackathon after navigating through several layers of defenses in about 3.5 minutes:
...
Here, our attacking voice agent first had to convince the AI chat system from the "customer support" to be forwarded to the "technical support" agent, which had access to the password. Then, it had to trick the technical support agent into revealing the password by exploiting prompt injection vulnerabilities.
